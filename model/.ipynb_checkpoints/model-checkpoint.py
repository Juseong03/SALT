...
class Model(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.mlp2 = sep_MLP(dim,num_continuous,np.ones(num_continuous).astype(int))
        
    def forward(self, x, mode = 'finetuning'):
        ...
        if mode == 'finetuning' :
            ...
            cat_outs = self.mlp1(output[:,:self.num_categories,:])
            con_outs = self.mlp2(output[:,self.num_categories:,:])
